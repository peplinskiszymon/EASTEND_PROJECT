...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\KategoriaFixtures.php';
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\ProduktFixtures.php';

        $a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($container);
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\KategoriaFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProduktFixtures(), 'groups' => []]]);
